...
describe("LoginAuthHandler", () => {
  ...
  container.register<IUserRepository>(userRepoToken, {
  ...
  it("should return the access token, userId and the role as USER with status code 200 if the USER logs in with correct userId", async () => {
    // Setup
    const req: Request = {
      body: { userIdEmail: mockUser.userId, password: mockUser.password },
    } as any as Request;
    const res: Response = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
  ...
  it("should return the access token, userId and the role as USER with status code 200 if the USER logs in with correct email", async () => {
    // Setup
    const req: Request = {
      body: { userIdEmail: mockUser.email, password: mockUser.password },
    } as any as Request;
    const res: Response = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
  ...
  it("should return the access token, userId and the role as ADMIN with status code 200 if the ADMIN logs in with correct userId", async () => {
    // Setup
    const req: Request = {
      body: { userIdEmail: mockAdmin.userId, password: mockAdmin.password },
    } as any as Request;
    const res: Response = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
  ...
  it("should return the access token, userId and the role as ADMIN with status code 200 if the ADMIN logs in with correct email", async () => {
    // Setup
    const req: Request = {
      body: { userIdEmail: mockAdmin.email, password: mockAdmin.password },
    } as any as Request;
    const res: Response = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
  ...
  it("should fail with status code 403 if password is not matched with userId", async () => {
    // Setup
    const req: Request = {
      body: { userId: mockUser.userId, password: mockUser.password },
    } as any as Request;
    const res: Response = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
  ...
  it("should fail with status code 403 if password is not matched with email", async () => {
    // Setup
    const req: Request = {
      body: { userId: mockUser.email, password: mockUser.password },
    } as any as Request;
    const res: Response = {
      status: jest.fn().mockReturnThis(),
      send: jest.fn(),
  ...
  describe("validation", () => {
    ...
    it("should return false if userId is provided, but password is null", () => {
      // Setup
      const req: Request = {
        body: { userIdEmail: mockUser.userId, password: null },
      } as any as Request;
    ...
    it("should return false if userId is provided, but password is undefined", () => {
      // Setup
      const req: Request = {
        body: { userIdEmail: mockUser.userId, password: undefined },
      } as any as Request;
    ...
    it("should return false if password is provided, but userId is null", () => {
      // Setup
      const req: Request = {
        body: { userIdEmail: null, password: mockUser.password },
      } as any as Request;
    ...
    it("should return false if password is provided, but userId is undefined", () => {
      // Setup
      const req: Request = {
        body: { userIdEmail: undefined, password: mockUser.password },
      } as any as Request;
    ...
    it("should return false if both password and userId are null", () => {
      // Setup
      const req: Request = {
        body: { userIdEmail: null, password: null },
      } as any as Request;
    ...
    it("should return false if both password and userId are undefined", () => {
      // Setup
      const req: Request = {
        body: { userId: undefined, password: undefined },
      } as any as Request;

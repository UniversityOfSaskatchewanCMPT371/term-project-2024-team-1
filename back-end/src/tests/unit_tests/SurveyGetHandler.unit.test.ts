...
import { SurveyGetHandler } from "@app/adapter/Controllers/Handlers/SurveyGetHandler";
...
describe("SurveyGetHandler", () => {
  ...
  const handler: SurveyGetHandler = container.resolve(SurveyGetHandler);
  let req: Request;
  let res: Response;

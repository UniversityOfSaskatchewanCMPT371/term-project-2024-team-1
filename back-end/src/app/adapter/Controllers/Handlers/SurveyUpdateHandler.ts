...
@injectable()
export class SurveyUpdateHandler implements IRouteHandler<SurveyQuestion[]> {
  private readonly _logger: ILogger = LoggerFactory.getLogger(SurveyUpdateHandler.name);
